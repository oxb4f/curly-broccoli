import iphoneScreen from '@app/assets/images/iphone-screen.png';
import googlePlayDownload from '@app/assets/images/google-play-download.png';
import appStoreDownload from '@app/assets/images/app-store-download.png';

const AuthAppBanner = ({ className = '' }) => {
  return (
